...
namespace LapTop.Controllers
{
    ...
    public class SanphamController : Controller
    {
        ...
        {
            var lAPTOPContext = _context.Sanphams.Include(s => s.IddongSanPhamNavigation).Include(s => s.IdloaiPhuKienNavigation).Include(s => s.IdnoiSanXuatNavigation);
        ...
        public async Task<IActionResult> Create(IFormFile file, [Bind("Id,IdnoiSanXuat,IddongSanPham,IdloaiPhuKien,TenSanPham,AnhSanPham,GiaBan,GiaKhuyenMai,NgayBatDauKhuyenMai,NgayKetThucKhuyenMai,SoLuong,MoTa,BaoHanh")] Sanpham sanpham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(IFormFile file, int id, [Bind("Id,IdnoiSanXuat,IddongSanPham,IdloaiPhuKien,TenSanPham,AnhSanPham,GiaBan,GiaKhuyenMai,NgayBatDauKhuyenMai,NgayKetThucKhuyenMai,SoLuong,MoTa,BaoHanh")] Sanpham sanpham)
        {
            if (id != sanpham.Id)
            {
                return NotFound();
