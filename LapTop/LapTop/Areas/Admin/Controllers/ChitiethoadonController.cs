...
namespace LapTop.Controllers
{
    ...
    public class ChitiethoadonController : Controller
    {
        ...
        {
            var lAPTOPContext = _context.Chitiethoadons.Include(c => c.IdhoaDonNavigation).Include(c => c.IdsanPhamNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdhoaDon,IdsanPham,SoLuongMua,DonGia")] Chitiethoadon chitiethoadon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdhoaDon,IdsanPham,SoLuongMua,DonGia")] Chitiethoadon chitiethoadon)
        {
